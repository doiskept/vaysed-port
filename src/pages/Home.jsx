      ...
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
            ...
            <motion.h2 variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 } }}>
              <span className="font-extrabold">Back-end</span>{" "}
              <span
          ...
          >
            Passionate about technology, I specialize in Development, with a special focus on Python and JavaScript, as well as Node.js and Django. I am focused on building innovative, creative, and functional solutions that solve real-world problems, and I strive to continuously expand my skills. My goal is to grow as a developer and contribute to impactful projects in the tech industry.
          </motion.p>
